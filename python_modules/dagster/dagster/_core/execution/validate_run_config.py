...
def validate_run_config(
    ...
    job_def = check.opt_inst_param(job_def, "job_def", (JobDefinition, JobDefinition))
    pipeline_def = check.opt_inst_param(pipeline_def, "pipeline_def", JobDefinition)
    ...
    pipeline_or_job_def = cast(JobDefinition, pipeline_def or job_def)
