...
class ShopifySource(GeneratedAirbyteSource):
    ...
    def __init__(
        ...
        Args:
            ...
            credentials (Union[APIPassword, OAuth20]): The authorization method to use to retrieve data from Shopify
...
class TiktokMarketingSource(GeneratedAirbyteSource):
    ...
    def __init__(
        ...
        Args:
            name (str): The name of the destination.
            credentials (Union[OAuth20, SandboxAccessToken]): Authentication method
...
class GoogleSheetsSource(GeneratedAirbyteSource):
    ...
    def __init__(
        ...
        Args:
            ...
            credentials (Union[AuthenticateViaGoogleOAuth, ServiceAccountKeyAuthentication]): Credentials for connecting to the Google Sheets API
        """
...
class GoogleAnalyticsV4Source(GeneratedAirbyteSource):
    ...
    def __init__(
        ...
        Args:
            name (str): The name of the destination.
            credentials (Union[AuthenticateViaGoogleOauth, ServiceAccountKeyAuthentication]): Credentials for the service
...
class OracleSource(GeneratedAirbyteSource):
    ...
    def __init__(
        ...
        Args:
            ...
            connection_data (Union[ServiceName, SystemIDSID]): Connect data that will be used for DB connection
            username (str): The username which is used to access the database.
            ...
            jdbc_url_params (Optional[str]): Additional properties to pass to the JDBC URL string when connecting to the database formatted as 'key=value' pairs separated by the symbol '&'. (example: key1=value1&key2=value2&key3=value3).
            encryption (Union[Unencrypted, NativeNetworkEncryptionNNE, TLSEncryptedVerifyCertificate]): The encryption method with is used when communicating with the database.
        """
        self.host = check.str_param(host, "host")
        self.port = check.int_param(port, "port")
...
class GoogleDirectorySource(GeneratedAirbyteSource):
    ...
    def __init__(self, name: str, credentials: Union[SignInViaGoogleOAuth, ServiceAccountKey]):
        ...
        Args:
            name (str): The name of the destination.
            credentials (Union[SignInViaGoogleOAuth, ServiceAccountKey]): Google APIs use the OAuth 2.0 protocol for authentication and authorization. The Source supports Web server application and Service accounts scenarios.
        """
        self.credentials = check.inst_param(
            credentials,
            "credentials",
...
class MixpanelSource(GeneratedAirbyteSource):
    ...
    def __init__(
        ...
        Args:
            name (str): The name of the destination.
            credentials (Union[ServiceAccount, ProjectSecret]): Choose how to authenticate to Mixpanel
...
class FaunaSource(GeneratedAirbyteSource):
    ...
    def __init__(
        ...
        Args:
            ...
            collection (Collection): Settings for the Fauna Collection.
        """
        self.domain = check.str_param(domain, "domain")
        self.port = check.int_param(port, "port")
...
class SalesforceSource(GeneratedAirbyteSource):
    ...
    def __init__(
        ...
        Args:
            ...
            streams_criteria (Optional[List[FilterSalesforceObjectsEntry]]): Filter streams relevant to you
        """
...
class PipedriveSource(GeneratedAirbyteSource):
    ...
    def __init__(
        ...
        Args:
            name (str): The name of the destination.
            authorization (Union[SignInViaPipedriveOAuth, APIKeyAuthentication]): Choose one of the possible authorization method
...
class FileSource(GeneratedAirbyteSource):
    ...
    def __init__(
        ...
        Args:
            ...
            provider (Union[HTTPSPublicWeb, GCSGoogleCloudStorage, S3AmazonWebServices, AzBlobAzureBlobStorage, SSHSecureShell, SCPSecureCopyProtocol, SFTPSecureFileTransferProtocol, LocalFilesystemLimited]): The storage Provider or Location of the file(s) which should be replicated.
        """
...
class MicrosoftTeamsSource(GeneratedAirbyteSource):
    ...
    def __init__(
        ...
        Args:
            ...
            credentials (Union[AuthenticateViaMicrosoftOAuth20, AuthenticateViaMicrosoft]): Choose how to authenticate to Microsoft
        """
...
class LeverHiringSource(GeneratedAirbyteSource):
    ...
    def __init__(
        ...
        Args:
            name (str): The name of the destination.
            credentials (OAuthCredentials): Choose how to authenticate to Lever Hiring.
...
class Db2Source(GeneratedAirbyteSource):
    ...
    def __init__(
        ...
        Args:
            ...
            jdbc_url_params (Optional[str]): Additional properties to pass to the JDBC URL string when connecting to the database formatted as 'key=value' pairs separated by the symbol '&'. (example: key1=value1&key2=value2&key3=value3).
            encryption (Union[Unencrypted, TLSEncryptedVerifyCertificate]): Encryption method to use when communicating with the database
        """
        self.host = check.str_param(host, "host")
        self.port = check.int_param(port, "port")
...
class SlackSource(GeneratedAirbyteSource):
    ...
    def __init__(
        ...
        Args:
            ...
            credentials (Union[DefaultOAuth20Authorization, APITokenCredentials]): Choose how to authenticate into Slack
        """
        self.start_date = check.str_param(start_date, "start_date")
...
class RetentlySource(GeneratedAirbyteSource):
    ...
    def __init__(
        ...
        Args:
            name (str): The name of the destination.
            credentials (Union[AuthenticateViaRetentlyOAuth, AuthenticateWithAPIToken]): Choose how to authenticate to Retently
        """
        self.credentials = check.inst_param(
            credentials,
            "credentials",
...
class S3Source(GeneratedAirbyteSource):
    ...
    def __init__(
        ...
        Args:
            ...
            format (Union[CSV, Parquet, Avro, Jsonl]): The format of the files you'd like to replicate
            ...
            provider (S3AmazonWebServices): Use this to load files from S3 or S3-compatible services
        """
...
class MssqlSource(GeneratedAirbyteSource):
    ...
    def __init__(
        ...
        Args:
            ...
            password (Optional[str]): The password associated with the username.
            jdbc_url_params (Optional[str]): Additional properties to pass to the JDBC URL string when connecting to the database formatted as 'key=value' pairs separated by the symbol '&'. (example: key1=value1&key2=value2&key3=value3).
            ssl_method (Union[Unencrypted, EncryptedTrustServerCertificate, EncryptedVerifyCertificate]): The encryption method which is used when communicating with the database.
            replication_method (Union[Standard, LogicalReplicationCDC]): The replication method used for extracting data from the database. STANDARD replication requires no setup on the DB side but will not be able to represent deletions incrementally. CDC uses {TBC} to detect inserts, updates, and deletes. This needs to be configured on the source database itself.
        """
        self.host = check.str_param(host, "host")
        self.port = check.int_param(port, "port")
        self.database = check.str_param(database, "database")
...
class AsanaSource(GeneratedAirbyteSource):
    ...
    def __init__(self, name: str, credentials: Union[PATCredentials, OAuthCredentials]):
        ...
        Args:
            name (str): The name of the destination.
            credentials (Union[PATCredentials, OAuthCredentials]): Choose how to authenticate to Github
        """
        self.credentials = check.inst_param(
...
class MongodbV2Source(GeneratedAirbyteSource):
    ...
    def __init__(
        ...
        Args:
            name (str): The name of the destination.
            instance_type (Union[StandaloneMongoDbInstance, ReplicaSet, MongoDBAtlas]): The MongoDb instance to connect to. For MongoDB Atlas and Replica Set TLS connection is used by default.
...
class FileSecureSource(GeneratedAirbyteSource):
    ...
    def __init__(
        ...
        Args:
            ...
            reader_options (Optional[str]): This should be a string in JSON format. It depends on the chosen file format to provide additional options and tune its behavior.
            url (str): The URL path to access the file which should be replicated.
            provider (Union[HTTPSPublicWeb, GCSGoogleCloudStorage, S3AmazonWebServices, AzBlobAzureBlobStorage, SSHSecureShell, SCPSecureCopyProtocol, SFTPSecureFileTransferProtocol]): The storage Provider or Location of the file(s) which should be replicated.
        """
        self.dataset_name = check.str_param(dataset_name, "dataset_name")
        self.format = check.str_param(format, "format")
        self.reader_options = check.opt_str_param(reader_options, "reader_options")
...
class ZendeskSupportSource(GeneratedAirbyteSource):
    ...
    def __init__(
        ...
        Args:
            ...
            credentials (Union[OAuth20, APIToken]): Zendesk service provides two authentication methods. Choose between: `OAuth2.0` or `API token`.
        """
        self.start_date = check.str_param(start_date, "start_date")
        self.subdomain = check.str_param(subdomain, "subdomain")
        self.credentials = check.inst_param(
...
class ZendeskTalkSource(GeneratedAirbyteSource):
    ...
    def __init__(
        ...
        Args:
            name (str): The name of the destination.
            subdomain (str): This is your Zendesk subdomain that can be found in your account URL. For example, in https://{MY_SUBDOMAIN}.zendesk.com/, where MY_SUBDOMAIN is the value of your subdomain.
            credentials (Union[APIToken, OAuth20]): Zendesk service provides two authentication methods. Choose between: `OAuth2.0` or `API token`.
...
class SftpSource(GeneratedAirbyteSource):
    ...
    def __init__(
        ...
        Args:
            ...
            credentials (Union[PasswordAuthentication, SSHKeyAuthentication]): The server authentication method
...
class Dv360Source(GeneratedAirbyteSource):
    ...
    def __init__(
        ...
        Args:
            name (str): The name of the destination.
            credentials (Oauth2Credentials): Oauth2 credentials
...
class NotionSource(GeneratedAirbyteSource):
    ...
    def __init__(self, name: str, start_date: str, credentials: Union[OAuth20, AccessToken]):
        ...
        Args:
            ...
            credentials (Union[OAuth20, AccessToken]): Pick an authentication method.
        """
        self.start_date = check.str_param(start_date, "start_date")
        self.credentials = check.inst_param(
...
class HubspotSource(GeneratedAirbyteSource):
    ...
    def __init__(self, name: str, start_date: str, credentials: Union[OAuth, APIKey, PrivateAPP]):
        ...
        Args:
            name (str): The name of the destination.
            start_date (str): UTC date and time in the format 2017-01-25T00:00:00Z. Any data before this date will not be replicated.
            credentials (Union[OAuth, APIKey, PrivateAPP]): Choose how to authenticate to HubSpot.
        """
        self.start_date = check.str_param(start_date, "start_date")
        self.credentials = check.inst_param(
            credentials,
...
class HarvestSource(GeneratedAirbyteSource):
    ...
    def __init__(
        ...
        Args:
            ...
            replication_start_date (str): UTC date and time in the format 2017-01-25T00:00:00Z. Any data before this date will not be replicated.
            credentials (Union[AuthenticateViaHarvestOAuth, AuthenticateWithPersonalAccessToken]): Choose how to authenticate to Harvest.
        """
        self.account_id = check.str_param(account_id, "account_id")
        self.replication_start_date = check.str_param(
            replication_start_date, "replication_start_date"
...
class GithubSource(GeneratedAirbyteSource):
    ...
    def __init__(
        ...
        Args:
            name (str): The name of the destination.
            credentials (Union[OAuthCredentials, PATCredentials]): Choose how to authenticate to GitHub
...
class FacebookMarketingSource(GeneratedAirbyteSource):
    ...
    def __init__(
        ...
        Args:
            ...
            custom_insights (Optional[List[InsightConfig]]): A list which contains insights entries, each entry must have a name and can contains fields, breakdowns or action_breakdowns)
...
class KafkaSource(GeneratedAirbyteSource):
    ...
    def __init__(
        ...
        Args:
            name (str): The name of the destination.
            MessageFormat (Union[JSON, AVRO]): The serialization used based on this
            ...
            subscription (Union[ManuallyAssignAListOfPartitions, SubscribeToAllTopicsMatchingSpecifiedPattern]): You can choose to manually assign a list of partitions, or subscribe to all topics matching specified pattern to get dynamically assigned partitions.
            ...
            protocol (Union[PLAINTEXT, SASLPLAINTEXT, SASLSSL]): The Protocol used to communicate with brokers.
